...
const API = {
  ...
  USER_DETAIL: '/hserve/v2.1/user/info/:userID/',
  USER_LIST: '/hserve/v2.1/user/info/',
  UPDATE_USER: '/hserve/v2.1/user/info/',

  TABLE_LIST: '/hserve/v2.0/table/',
  TABLE_DETAIL: '/hserve/v2.0/table/:tableID/',
  RECORD_LIST: '/hserve/v2.1/table/:tableID/record/',
  QUERY_RECORD_LIST: '/hserve/v2.1/table/:tableID/record/',
  CREATE_RECORD_LIST: '/hserve/v2.1/table/:tableID/record/?enable_trigger=:enable_trigger',
  RECORD_DETAIL: '/hserve/v2.1/table/:tableID/record/:recordID/',
  CREATE_RECORD: '/hserve/v2.1/table/:tableID/record/',
  UPDATE_RECORD: '/hserve/v2.1/table/:tableID/record/:recordID/',
  UPDATE_RECORD_LIST: '/hserve/v2.1/table/:tableID/record/?limit=:limit&offset=:offset&where=:where&enable_trigger=:enable_trigger',
  DELETE_RECORD: '/hserve/v2.1/table/:tableID/record/:recordID/',
  DELETE_RECORD_LIST: '/hserve/v2.1/table/:tableID/record/?limit=:limit&offset=:offset&where=:where&enable_trigger=:enable_trigger',
